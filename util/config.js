...
export default async function config() {
  try {
    ...
    return {
      ...
      NEXT_PUBLIC_EXTERNAL_API: process.env.NEXT_PUBLIC_EXTERNAL_API !== undefined ? process.env.NEXT_PUBLIC_EXTERNAL_API: (window.location.origin + '/mcf10a-notebooks/api'),
    }
  }
}
