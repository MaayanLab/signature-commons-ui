			...
			<Grid container spacing={3}>
				<Grid xs={12}>
					<Grid container>
						...
						<Grid xs={12} xl={6} md={4} style={{paddingRight: 20}}>
						...
						<Grid xs={12} xl={6} md={8} style={{paddingLeft: 20}}>
